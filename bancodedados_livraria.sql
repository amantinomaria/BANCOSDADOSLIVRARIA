...
CREATE TABLE `livraria` (
  `cnpj_livraria` char(14) NOT NULL,
  ...
  KEY `cep` (`cep`),
  CONSTRAINT `livraria_ibfk_1` FOREIGN KEY (`cep`) REFERENCES `endereco` (`cep`)
...
INSERT INTO `livraria` VALUES ('33333333000191','Livrarias Guarapuava','41911112222','80010000',10);
